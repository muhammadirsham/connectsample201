...
//!
//! @param version If the provider supports versioning, this is the version of the file that was just written, otherwise blank.
//! @param hash If the provider supports hashing, this is the hash of the file that was just written, otherwise blank.
typedef void
